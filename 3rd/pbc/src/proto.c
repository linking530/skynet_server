...
//eg 从pbc_env->msgs中取出"tutorial.Person"对应的_message
struct _message * 
...
//type_name:+		type_name	0x093dfa78 "users.users_info"	const char *
//key +		key	0x093de288 "userid"	const char *
int 
