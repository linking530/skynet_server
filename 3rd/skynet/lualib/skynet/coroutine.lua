-- You should use this module (skynet.coroutine) 
--instead of origin lua coroutine in skynet framework

local coroutine = coroutine
-- origin lua coroutine module
--函数coroutine.resume使协同程序由挂起状态变为运行态：
local coroutine_resume = coroutine.resume
--使用函数yield可以使程序挂起，当我们激活被挂起的程序时，
--将从函数yield的位置继续执行程序，直到再次遇到yield或程序结束。
